---
description: Common Mod, DIfferent e
---

# Common Mistake

In this challenge, we are given two sets of $$N$$, $$e$$ and $$c$$.
...
The plaintext encrypted to give $$c$$ is the same, and we can observe that the choice of $$N$$ is also the same, meaning the only difference is in the choice of $$e$$. Here we can use some cool maffs with $$e_1$$ and $$e_2$$ to retrieve the original plaintext $$m$$.

Firstly, if the greatest common divisor of $$e_1$$ and $$e_2$$ is $$1$$, then there exists $$a$$ and $$b$$ such that
